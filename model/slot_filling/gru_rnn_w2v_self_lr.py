...
class GruRNN(BasicRNN):
    ...
    def __init__(self, in_dim, hidden_dim, out_dim, word_emb, bptt_truncate=-1, activation='tanh'):
        ...
        self.emb = theano.shared(name='emb', value=word_emb.astype(theano.config.floatX))
