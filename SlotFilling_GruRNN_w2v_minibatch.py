from model.slot_filling.gru_rnn_minibatch_w2v import GruRNN
import os
import cPickle
import numpy as np
import theano
...
model_dir = os.path.join(root_dir, 'model', 'slot_filling', 'GruMiniBatchW2V_%s_%f_%d_%d' % (data_group, lr, batch_size, nepoch))
